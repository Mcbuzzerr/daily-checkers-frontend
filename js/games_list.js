...
const getGameList = async () => {
    let url = `https://jovfbj0dwc.execute-api.us-east-1.amazonaws.com/${STAGE}/game/list`
...
const handleConcedeClicked = (gameId) => {
    ...
    if (areTheySure) {
        fetch(`https://jovfbj0dwc.execute-api.us-east-1.amazonaws.com/${STAGE}/game/concede/${gameId}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${getCookie('authToken')}`,
...
const handleNewGameClicked = (event) => {
    ...
    fetch(`https://jovfbj0dwc.execute-api.us-east-1.amazonaws.com/${STAGE}/invite/random`,
        {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
